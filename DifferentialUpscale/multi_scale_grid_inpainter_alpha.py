...
class MultiScaleGridInpainterAlpha:
    def __init__(self, input_image_path, mask_path="mask.png", temp_file="q.png", 
        ...
        """
        Initialize the multi-scale grid inpainter with alpha blending
        ...
        self.scale_steps = [
            ...
            },
            {
                ...
                "stride": 256,
                "brightness": -4.5,
                "prompt": "extremely intricate and detailed, a giant tree with gnarled bark with leaves made of bird feathers in a forest made of flock of hundreds of birds, made of wax, paper cutout,  beautiful oil painting by hieronymous bosch",
            ...
            },
            {
                ...
                "stride": 256,
                "brightness": -3.5,
                "prompt": "extremely intricate and detailed, mandelbulb fractal made of wax, paper, wire, and bones by Ernst Haeckel, beautiful oil painting by hieronymous bosch",
                "output_file": "result_16k.png"
            }
        ]
        
        print("Multi-Scale Grid Inpainting Pipeline (with Alpha Blending)")
        print("=" * 60)
    ...
    def process_scale_step(self, input_image_path, step_config):
        ...
        print(f"\nProcessing {step_name} ({target_size}x{target_size}) with Alpha Blending")
        print("-" * 50)
    ...
    def run_full_pipeline(self):
        ...
        print("\nStarting Multi-Scale Pipeline with Alpha Blending...")
        print("=" * 60)
        ...
        print("\n" + "=" * 60)
        print("🎉 FULL PIPELINE COMPLETED WITH ALPHA BLENDING!")
        print("Results:")
...
def main():
    ...
    # Create the multi-scale inpainter with alpha blending
    pipeline = MultiScaleGridInpainterAlpha(
